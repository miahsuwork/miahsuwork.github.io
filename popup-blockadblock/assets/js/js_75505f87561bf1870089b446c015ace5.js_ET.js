...
$(document).ready(function(){
	...
	imageloader.each(function() {
		$(this).show();
		$("#ads_l").load(
			"/sites/all/modules/comad/ads.php?language=" + $("#ads_l").attr("language"),
	...
	var imageloader_evt = $("#imageloader_evt");
	imageloader_evt.each(function() {
		$(this).show();
		$("#ads_evt").load(
			"/sites/all/modules/comad/ads.php?language=" + $("#ads_evt").attr("language") + "&type=EVENT",
			function (responseText, textStatus, XMLHttpRequest){
				imageloader_evt.hide();
				$(this).html(responseText);
			}
		);
	});
	
	var imageloader_headL = $("#imageloader_headL");
    imageloader_headL.each(function() {
        $(this).show();
        $("#ads_head_l").load(
            "/sites/all/modules/comad/ads.php?language=" + $("#ads_head_l").attr("language") + "&type=HEAD_L",
            function (responseText, textStatus, XMLHttpRequest){
                imageloader_headL.hide();
                $(this).html(responseText);
            }
        );
    });
	
	var imageloader_headR = $("#imageloader_headR");
    imageloader_headR.each(function() {
        $(this).show();
        $("#ads_head_r").load(
            "/sites/all/modules/comad/ads.php?language=" + $("#ads_head_r").attr("language") + "&type=HEAD_R",
            function (responseText, textStatus, XMLHttpRequest){
                imageloader_headR.hide();
                $(this).html(responseText);
            }
        );
		$("#ads_head_h3").load(
            "/sites/all/modules/comad/ads.php?language=" + $("#ads_head_h3").attr("language") + "&type=HEAD_h3",
            function (responseText, textStatus, XMLHttpRequest){
                imageloader_headR.hide();
                $(this).html(responseText);
            }
		...
		/*$("#ads_pvr").load(
            "/sites/all/modules/comad/ads.php?language=" + $("#ads_pvr").attr("language") + "&type=PVR",
            function (responseText, textStatus, XMLHttpRequest){
                imageloader_headR.hide();
                $(this).html(responseText);
            }
	...
	var imageloader_lt = $("#imageloader_lt");
	imageloader_lt.each(function() {
		$(this).show();
		$("#ads_lt").load(
			"/sites/all/modules/comad/ads.php?language=" + $("#ads_lt").attr("language") + "&type=LT",
			function (responseText, textStatus, XMLHttpRequest){
				imageloader_lt.hide();
				$(this).html(responseText);
			}
	...
	var imageloader_rt = $("#imageloader_rt");
	imageloader_rt.each(function() {
		$(this).show();
		$("#ads_rt").load(
			"/sites/all/modules/comad/ads.php?language=" + $("#ads_rt").attr("language") + "&type=RT",
			function (responseText, textStatus, XMLHttpRequest){
				imageloader_rt.hide();
				$(this).html(responseText);
			}
